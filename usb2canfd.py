...
def CANFD_GetCANSpeedArg(DevHandle, pCanConfig, SpeedBpsNBT, SpeedBpsDBT):
    return USB2XXXLib.CANFD_GetCANSpeedArg(DevHandle, pCanConfig, SpeedBpsNBT, SpeedBpsDBT)
